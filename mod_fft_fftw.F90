!
! $Id: mod_fft_fftw.F90 1907 2013-11-26 13:10:46Z lguez $
!

MODULE mod_fft_fftw

        !USE print_control_mod, ONLY: lunout !Mohammad
...
! On initialise tous les plans 
    ...
    !WRITE(*,*)"!-------------------------!"
    !WRITE(*,*)"!-----------Mohammad  INIT Subroutine------!"
    !WRITE(*,*)"!-----Print declared varaibale to test en offline-------!"
    !WRITE(*,*)"!-----------Mohammad------!"
    !WRITE(*,*)" iim    (Mohammad) : ", iim
    !WRITE(*,*)" nvectmax  (Mohammad) : ",nvectmax
    !WRITE(*,*)" scale_factor  (Mohammad) : ",scale_factor
...
#include <fftw3.f>
    ...
    !WRITE(*,*)"!-------------------------!"
    !WRITE(*,*)"!-----------Mohammad  fft_forward Subroutine------!"
    !WRITE(*,*)"!-----Print declared varaibale to test en offline-------!"
    !WRITE(*,*)"!-----------Mohammad------!"
    !WRITE(*,*)" nb_vect    (Mohammad) : ", nb_vect
    !WRITE(*,*)" vect  (Mohammad) : ",vect
    !WRITE(*,*)" scale_factor  (Mohammad) : ",scale_factor
    !WRITE(*,*)" vsize  (Mohammad) : ",vsize
...
#include <fftw3.f>
    ...
    !WRITE(*,*)"!-------------------------!"
    !WRITE(*,*)"!-----------Mohammad  fft_backward Subroutine------!"
    !WRITE(*,*)"!-----Print declared varaibale to test en offline-------!"
    !WRITE(*,*)"!-----------Mohammad------!"
    !WRITE(*,*)" nb_vect    (Mohammad) : ", nb_vect
    !WRITE(*,*)" TF_vect  (Mohammad) : ",TF_vect
    !WRITE(*,*)" scale_factor  (Mohammad) : ",scale_factor
    !WRITE(*,*)" vsize  (Mohammad) : ",vsize
